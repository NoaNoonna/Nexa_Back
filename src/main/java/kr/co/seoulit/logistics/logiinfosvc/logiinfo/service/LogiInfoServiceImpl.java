...
import kr.co.seoulit.logistics.logiinfosvc.logiinfo.mapstruct.ItemGroupResMapStructImpl;
...
public class LogiInfoServiceImpl implements LogiInfoService {
	...
	private final ItemGroupResMapStructImpl itemGroupResMapStruct;
	...
	@Override
	@Cacheable("searchItemList")
	public ArrayList<ItemGroupResDto> searchItemList(){
		List<ItemGroupEntity> itemList = itemGroupRepository.findAll();
		ArrayList<ItemGroupResDto> itemGroup = (ArrayList<ItemGroupResDto>) itemGroupResMapStruct.toDto(itemList);
